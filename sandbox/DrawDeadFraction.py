...
if __name__ == '__main__':
    inDir = '/global/projecta/projectdirs/majorana/users/mbuuck/sim/MJDWithGrahamTDL_byDetESmearing/0.75_transition_point/0.50_transition_level/MJDemonstrator/linesource/M1CalSource/A224_Z88'
    # inDir = '/mnt/mjdDisk1/Majorana/users/psz/MAGE/micah'
    simTree = ROOT.TChain("simTree")
    simTree.Add('{}/*.root'.format(inDir))
