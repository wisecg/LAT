...
int main()
{
  ...
  double *energy = 0; // x-ray energies for the element, in keV
  double ene[9] = {0};
  energy = ene;

  double *xsec =0; // various crossections and material constants for the element.
  double xs[11] = {0};
  xsec = xs;

  double *fl_yield = 0;//- fluorescent yield for the element
  double fl[4] = {0};
  fl_yield = fl;

  char *err_msg = 0; // text of error message (if any).
